...
$(document).ready(function(){$(window).load(function(){var e=$(".owl-carousel");e.owlCarousel({lazyLoad:!0,loop:!0,responsiveClass:!0,responsive:{0:{items:2,dots:!1,loop:!0},768:{items:3,dots:!1,loop:!0},1024:{items:4,dots:!1,loop:!0},1200:{items:6,dots:!1,loop:!0}}})});var e,t,n,o,i;$(".main_category h3").click(function(a){e=$(this).parent(),0==e.find(".ink").length&&e.prepend("<span class='ink'></span>"),t=e.find(".ink"),t.removeClass("animate"),t.height()||t.width()||(n=Math.max(e.outerWidth(),e.outerHeight()),t.css({height:n,width:n})),o=a.pageX-e.offset().left-t.width()/2,i=a.pageY-e.offset().top-t.height()/2,t.css({top:i+"px",left:o+"px"}).addClass("animate")}),$(window).load(function(){function e(e){e.addEventListener("click",function(e){e.preventDefault(),this.classList.contains("is-active")===!0?this.classList.remove("is-active"):this.classList.add("is-active")})}for(var t=document.querySelectorAll(".browse-link"),n=t.length-1;n>=0;n--){var o=t[n];e(o)}}),$(window).load(function(){var e=$("#open-close");e.click(function(){$("#browse-categories").slideToggle("fast")})}),$(".search-box").first().expandSearch(),$(window).load(function(){function e(){if(classie.has(n,"open")){classie.remove(n,"open"),classie.add(n,"close");var e=function(t){if(support.transitions){if("visibility"!==t.propertyName)return;this.removeEventListener(transEndEventName,e)}classie.remove(n,"close")};support.transitions?n.addEventListener(transEndEventName,e):e()}else classie.has(n,"close")||classie.add(n,"open")}var t=document.getElementById("trigger-info-modal"),n=document.querySelector("section.info-modal"),o=n.querySelector("a.info-modal-close");transEndEventNames={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd",msTransition:"MSTransitionEnd",transition:"transitionend"},transEndEventName=transEndEventNames[Modernizr.prefixed("transition")],support={transitions:Modernizr.csstransitions},t.addEventListener("click",e),o.addEventListener("click",e)}),$(window).load(function(){var e=$(".post-container");e.isotope({itemSelector:".post-item",masonry:{columnWidth:".grid-sizer"}})}),$(".post-content").theiaStickySidebar({additionalMarginTop:0}),$(".back-to-top").click(function(){$("html, body").animate({scrollTop:0},"slow")});var a=window.location.protocol+"//"+window.location.host+"/"+window.location.pathname,r=document.getElementsByTagName("title")[0].innerHTML,s=document.querySelector("meta[name='description']").getAttribute("content"),c=document.querySelectorAll(".share--twitter");Array.prototype.forEach.call(c,function(e,t){e.addEventListener("click",function(e){e.preventDefault();var t=this.getAttribute("data-message")+" "+r;window.open("http://twitter.com/share?url="+encodeURIComponent(a)+"&text="+encodeURIComponent(t)+"&count=none/","tweet","height=300,width=550,resizable=1")})});var l=document.querySelectorAll(".share--facebook");Array.prototype.forEach.call(l,function(e,t){e.addEventListener("click",function(e){e.preventDefault(),window.open("http://www.facebook.com/sharer.php?u="+encodeURIComponent(a)+"&t="+encodeURIComponent(r),"facebook","height=300,width=550,resizable=1")})});var d=document.querySelectorAll(".share--googleplus");Array.prototype.forEach.call(d,function(e,t){e.addEventListener("click",function(e){e.preventDefault(),window.open("https://plus.google.com/share?url="+encodeURIComponent(a),"google +","height=300,width=550,resizable=1")})});var p=document.querySelectorAll(".share--pinterest");Array.prototype.forEach.call(p,function(e,t){e.addEventListener("click",function(e){e.preventDefault();var t=this.getAttribute("data-image-url");window.open("https://pinterest.com/pin/create/button/?url="+encodeURIComponent(a)+"&media="+encodeURIComponent(t)+"&description="+encodeURIComponent(s),"pinterest","height=300,width=550,resizable=1")})})});
...
!function(e,t,n){var a;a=function(){function a(a,o){var i,r,c,u,f,l,s,d,h,v;d="."+n+(new Date).getTime(),v=e(t),f=e(document),c=e(o.CloseButton,a).first(),h=e(o.TextField,a).first(),r=!1,l=!1,s=function(){return e(document.createElement("div")).outerWidth(a.outerWidth(!0)).outerHeight(a.outerHeight(!0)).hide()},i=function(){var e;a.addClass(o.ActiveClassName).animate({opacity:1},300),r.show(),e=h.data("active-placeholder"),e&&(h.data("deactive-placeholder",h.attr("placeholder")),h.attr("placeholder",e)),f.on("keyup"+d,function(e){var t;return t=e.keyCode||e.which,27===t?u.call(self,e):void 0})},u=function(){var e;f.off("keyup"+d),h.blur(),e=h.data("deactive-placeholder"),a.animate({opacity:0},200,"swing",function(){return e&&h.attr("placeholder",e),r.hide(),a.removeClass(o.ActiveClassName).css("opacity","")})},this.on=function(){var t;l||(l=!0,t=this,r=s(),a.after(r),h.on("focus"+d,e.proxy(i,this)),c.on("click"+d,e.proxy(u,this)),v.on("scroll"+d,function(e){return e.preventDefault()}))},this.off=function(){l&&(r.remove(),h.off("focus"+d),c.off("click"+d),f.off("keyup"+d),v.off("scroll"+d),l=!1)}}return a}(),e.fn[n]=function(t){var o;return o=e.extend(!0,{},e.fn[n].defaults,t),this.each(function(){var t,i;return i=e(this),t=i.data(n),t||(t=new a(i,o),i.data(n,t)),t.on()})},e.fn[n].defaults={CloseButton:".btn-close",TextField:"input[type=text]",ActiveClassName:"active"}}(jQuery,window,"expandSearch");
